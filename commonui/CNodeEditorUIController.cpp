...
#include <CBinarySortTreeEditorUI.h>   //打开注释
...
void CNodeEditorUIController::createPanels()
{
	...
	m_parent->createDockWindow(
		...
		m_linklistPanel = new CBinarySortTreeEditorUI(m_parent)
	);
	...
	//linklistPanel链接m_quickHelpPanel
...
void CNodeEditorUIController::onNewDocumentCreated()
{
	...
	m_editorScene->createClassAttribute("", "notes", "Comment", QString(), ATTR_NONE);
