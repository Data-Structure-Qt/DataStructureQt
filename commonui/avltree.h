...
public:
	...
	/*构造函数*/
	CBiTreeNode(char k, CBiTreeNode* left, CBiTreeNode* right, CBiTreeNode *mid) :data(k), height(0),
...
public:
	...
	//创建三叉树
	CBiTreeNode* creatThreeBitree(CBiTreeNode* root);

	//在 AVL 树 root 中查找值为 key 的结点并返回该结点
