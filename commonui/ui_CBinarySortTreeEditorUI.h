...
public:
    ...
    void setupUi(QWidget *CBinarySortTreeEditorUI)
    {
        ...
        groupBox->setGeometry(QRect(20, 50, 541, 291));
        label = new QLabel(groupBox);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(120, 30, 221, 20));
        ...
        nodeDeleteButton->setGeometry(QRect(240, 220, 112, 34));
        ...
        pushButton_5->setGeometry(QRect(110, 220, 112, 34));
