...
//		this,
//		m_currentFileName,
//		QStringLiteral("你已对该文件进行修改\n"
//			"请问是否保存你的更改?"),
//		QMessageBox::Save | QMessageBox::Discard | QMessageBox::Cancel);
//	ret.setButtonText(QMessageBox::Save, tr("保存"));
//	ret.setButtonText(QMessageBox::Discard, tr("不保存"));
//	ret.setButtonText(QMessageBox::Cancel, tr("取消"));
//
//
//	switch (ret) 
//	{
...
bool CMainWindow::saveOnExit()
{
	...
	/*QMessageBox *msgBox = QMessageBox::warning(
		...
		QStringLiteral("你已对该文件进行修改\n"
			"请问是否保存你的更改?"),
		QMessageBox::Save | QMessageBox::Discard | QMessageBox::Cancel);*/
	QMessageBox *msgBox = new QMessageBox(QMessageBox::Warning, m_currentFileName,
		QStringLiteral("你已对该文件进行修改\n"
						"请问是否保存你的更改?"),
		QMessageBox::Save | QMessageBox::Discard|QMessageBox::Cancel);

	msgBox->button(QMessageBox::Save)->setText(QStringLiteral("保存"));
	msgBox->button(QMessageBox::Discard)->setText(QStringLiteral("不保存"));
	msgBox->button(QMessageBox::Cancel)->setText(QStringLiteral("取消"));
	int ret = msgBox->exec();


	//QMessageBox::StandardButton ret = msgBox.exec();
