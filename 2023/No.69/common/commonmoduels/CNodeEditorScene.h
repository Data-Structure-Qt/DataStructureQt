...
public:
	...
	void tongResult(int location, int data);
	void drawText(int location);
	void drawResult(int location);//¥Ú”°°∞Õ∞≈≈–ÚΩ·π˚°±
	void drawTong(int location);//¥Ú”°°∞Õ∞≈≈–Úπ˝≥Ã°±
	...
	void clearScreen();
	void tong(int i,int location, int data);//Õ∞≈≈–Ú∆¡ƒª µœ÷
	void kongtong(int i, int location, int data);//ø’Õ∞
	void tongsize(int i,int location);//Õ∞«¯º‰
