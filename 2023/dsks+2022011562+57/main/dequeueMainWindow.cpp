...
dequeueMainWindow::dequeueMainWindow(QWidget* parent) :
	Super(parent)
{
	QString bitString;
	...
	QApplication::setApplicationVersion(dequeueVersionString);
...
dequeueMainWindow::~dequeueMainWindow()
{
	// causes crash here 
	destroyDocument();
}
void dequeueMainWindow::init(const QStringList& args)
{
...
QSettings& dequeueMainWindow::getApplicationSettings() const
{
	if (m_portable)
	{
...
bool dequeueMainWindow::createDocument(const QByteArray& docType)
{  // scene 
	if (docType == "graph")
	{
...
void dequeueMainWindow::destroyDocument()
{
...
void dequeueMainWindow::onNewDocumentCreated(const QByteArray& docType)
{
	// wizard 
	if (docType == "graph") {
...
bool dequeueMainWindow::openDocument(const QString& fileName,
	QByteArray& docType)
{
...
bool dequeueMainWindow::saveDocument(const QString& fileName,
...
QString dequeueMainWindow::getAboutText() const
{
...
void dequeueMainWindow::doReadSettings(QSettings& settings)
{
...
void dequeueMainWindow::doWriteSettings(QSettings& settings)
{
...
// privates 
void dequeueMainWindow::updateFileAssociations()
{
