...
public:
    ...
    // 构造函数
    CBiTreeNode(QChar k, CBiTreeNode* left = nullptr, CBiTreeNode* right = nullptr)
        : key(k.toLatin1()), height(0), left(left), right(right) {}
};
...
public:
    ...
    CBiTreeNode* buildTreeFromInorderPostorder(const QString& inorder, const QString& postorder);
