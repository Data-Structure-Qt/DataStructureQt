...
{
	if (m_edgesFactory)//��ɴ���һ���ߣ����ܲ��������ϵ�ṹ�Ĺ���ģʽ��
	{
		auto edge = dynamic_cast<CEdge*>(m_edgesFactory->create());//����ù���ģʽ����һ����
		Q_ASSERT(edge);
	...
	// here default
	return new CDirectEdge();//�������쳣
}


CEdge* CNodeEditorScene::createNewConnection(CNode* startNode, CNode* endNode)
{
	auto edge = createNewConnection();//����һ����
	addItem(edge);					  //���߼���Item
	edge->setFirstNode(startNode);	  //�����ÿ�ʼ�ڵ�
	edge->setLastNode(endNode);		  //�����ý����ڵ�
	return edge;					  //���ر�
}
...
void CNodeEditorScene::insertnode(int location, int data)
{
	...
	auto node1 = createNewNode(getSnapped(orgin));//���ƾ���
	...
	if (flag)
	{
		auto node = createNewNode(getSnapped(orgin - addnext));//���ƾ���
		createNewConnection(node, node1);//���Ƽ�ͷ
		//createNewConnection(node1, node);//���Ƽ�ͷ��˫�����
	}
	QPointF next(50, 0);
	orgin = orgin + next;
	auto node2 = createNewNode(getSnapped(orgin));//���ƾ���
...
void CNodeEditorScene::insertfindnode(int location, int data)
{
	...
	QPointF addnext(100, 0);
	auto node1 = createSearchNode(getSnapped(orgin));//���ƾ���
	node1->setSelected(false);
	QGraphicsItem *hoverItem = getItemAt(getSnapped(orgin));
	CItem *item = dynamic_cast<CItem*>(hoverItem);
	onActionEditLabel(item, data);
	if (flag) {
		auto node = createSearchNode(getSnapped(orgin - addnext));//���ƾ���
		createNewConnection(node, node1);//���Ƽ�ͷ
	}
	int px = orgin.x();
	int py = orgin.y();
	...
	QPointF next(50, 0);
	orgin = orgin + next;
	auto node2 = createSearchNode(getSnapped(orgin));//���ƾ���
...
void CNodeEditorScene::onLeftDoubleClick(QGraphicsSceneMouseEvent* mouseEvent, QGraphicsItem* clickedItem)
{
	...
	if (!clickedItem)
	{
		...
		addUndoState();
		return;
		//myPix = new QPixmap(1000,1000); //���Զ���Ļ��ư��С����Ϊ�����С
		//myPix->fill(Qt::white);  //Ĭ�Ͻ��Զ�����ư����Ϊ��ɫ
...
{
	QRectF Rect(-2000, -2000, 4000, 4000);//ɾ��-1000 -1000 1000 1000 �����ڵ�����ͼ��
...
void CNodeEditorScene::mousePressEvent(QGraphicsSceneMouseEvent* e) //��갴���¼�
{
	// 0220 ��������
...
void CNodeEditorScene::mouseMoveEvent(QGraphicsSceneMouseEvent* e) //����ƶ��¼�
{
	//����һ��������
	//QPainter painter(myPix); //�������Զ���Ļ���
	QPen pen;
	//�˴���Ҫ��ӻ����Զ�����ɫ
...
void CNodeEditorScene::paintEvent(QPaintEvent*) //�����¼�
{
	////1.��һ�����ң�������this����
