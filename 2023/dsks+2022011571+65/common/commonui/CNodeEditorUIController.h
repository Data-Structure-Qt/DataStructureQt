...
public:
  ...
  bool loadFromFile(const QString &format, const QString &fileName,
                    QString *lastError);
  bool saveToFile(const QString &format, const QString &fileName,
                  QString *lastError);
  ...
  // protected API
protected:
  CNodeEditorScene *scene() { return m_editorScene; }
...
private:
  ...
  class LinklistUI *m_linklistPanel = nullptr;
  class CDemo *m_demoPanel = nullptr;
