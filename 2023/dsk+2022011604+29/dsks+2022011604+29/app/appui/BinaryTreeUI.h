...
private slots:
    void on_drawTree_btn_clicked();// 绘制二叉树创建函数
  ...
  void inOrderPrint_search(CBiTreeNode *root, double x, double y,
                           ...
                           double p_y, int data, int frame);
  //仿真二叉树递归展示函数
  void inOrderPrint_SimulationTree(CBiTreeNode *root, double x, double y,
                                   double Branch_length, double Branch_angle,
  ...
  void animationRecord(int totaltime, int frame, int x, int y, int data1,
                       int data2, int p_x, int p_y);
  void animationSearchRecord(int totaltime, int frame, int x, int y, int data1,
                             int data2, int p_x, int p_y, int flag, int codeid);
  void animationClean();
  void animationPrint(int totaltime, int frametime);
  void animationDraw(int totaltime, int frametime);
  void animationDrawWithChar(int totaltime, int frametime);
