...
_again:
	...
	editNode->setId(newId);
	nodeScene.addUndoState();
	editNode->setSize(70, 70);
	editNode->setLabelText(editNode->getId());
	editNode->setLabelPosition(editNode->x() / 4096 - 10, editNode->y() / 4096 - 10);
	editNode->showLabel(true);
	return true;
}
...
_again:
	...
	editEdge->setId(newId);
	nodeScene.addUndoState();
	editEdge->setLabelText(editEdge->getId());
	editEdge->showLabel(true);
	//editEdge->setAttribute("direction", "directed");
	return true;
}
