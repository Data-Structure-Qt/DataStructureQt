...
private slots://平衡二叉树创建函数


	void visualizeMaxHeap();


	void on_binarytree_create_btn_clicked();//仿真二叉树创建函数
	void on_binarytree_SimulationTree_creat_btn_clicked();//平衡二叉树删除函数
	void on_binarytree_delete_btn_clicked();//平衡二叉树节点删除函数
	void on_binarytree_node_delete_btn_clicked();//平衡二叉树节点查找函数
	void on_binarytree_node_search_btn_clicked();//平衡二叉树递归展示函数
	void inOrderPrint(CBiTreeNode * root, double x, double y,double wideSize, double highSize, double p_x, double p_y, int frame);//用于搜索的平衡二叉树递归展示函数
	void inOrderPrint_search(CBiTreeNode * root, double x, double y,double wideSize, double highSize, double p_x, double p_y, int data, int frame);//仿真二叉树递归展示函数
	void inOrderPrint_SimulationTree(CBiTreeNode* root, double x,double y, double Branch_length, double Branch_angle,double Change_angle, double p_x, double p_y);//先序遍历
	void PreOrderBiTree(CBiTreeNode* root, string &In);//中序遍历
	void InOrderBiTree(CBiTreeNode* root, string &In);//后序遍历
	void PostOrderBiTree(CBiTreeNode* root, string &In);//获取树的高度
	void DepthOfBiTree(CBiTreeNode* root, int &In);//程序暂停时间time停留时间毫秒
