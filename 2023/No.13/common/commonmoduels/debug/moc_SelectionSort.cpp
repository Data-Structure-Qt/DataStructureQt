/****************************************************************************
** Meta object code from reading C++ file 'SelectionSort.h'
**
...
#error "The header file 'SelectionSort.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject SelectionSort::staticMetaObject = { {
    QMetaObject::SuperData::link<SortObejct::staticMetaObject>(),
    qt_meta_stringdata_SelectionSort.data,
    qt_meta_data_SelectionSort,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SelectionSort::qt_metacast(const char *_clname)
{
    ...
    return SortObejct::qt_metacast(_clname);
}

int SelectionSort::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SortObejct::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
