...
QT_MOC_LITERAL(5, 48, 11), // "setEditMode"
QT_MOC_LITERAL(6, 60, 8), // "EditMode"
QT_MOC_LITERAL(7, 69, 18) // "onSelectionChanged"

    },
    "CNodeEditorScene\0editModeChanged\0\0"
    "mode\0finished\0setEditMode\0EditMode\0"
    "onSelectionChanged"
};
...
void CNodeEditorScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setEditMode((*reinterpret_cast< EditMode(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CNodeEditorScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CNodeEditorScene::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void CNodeEditorScene::finished()
{
