...
void CQuickHelpUI::btree_create_code(int act)
{
	...
	case 1:
		...
		ui->Viewer->append("<div id = \"codet\" class = \"panel\" style = background-color: rgb(254, 197, 21); width: 420px;>"
			"<div id = \" code\" style = \"   background-color: rgb(254, 197, 21); color: rgb(0, 0, 0);font-size:18px;\">" + QString::fromLocal8Bit("查找最远路径") + "< / div >"
			"< / div>");
		...
		ui->Viewer->append("<div id = \"codetrace\" class = \"panel\" style = \"background-color: rgb(46, 187, 209); width: 420px; height: 420px;\">"
			"<div id = \" code1\" style = \"   background-color: rgb(0, 0, 0); color: rgb(255, 255, 255);font-size:18px;\">" + QString::fromLocal8Bit("查找最远路径") + "< / div>"
			"<div id = \"code2\" style = \" background-color: rgb(0, 0, 0); color: rgb(255, 255, 255);font-size:18px;\">" + QString::fromLocal8Bit(" &nbsp;开始查找路径并标红") + "< / div>"
			...
			"<div id = \"code4\" style = \" background-color: rgb(46,187, 209);  color: rgb(255, 255, 255);font-size:18px;\">" + QString::fromLocal8Bit("&nbsp;查找左子树并标红") + "< / div>"
			"<div id = \"code5\" style = \"background-color: rgb(46, 187, 209); color: rgb(255, 255, 255);font-size:18px;\">" + QString::fromLocal8Bit("查找右子树并标红") + "< / div>"
			"< / div>");
		break;
	case 2:
		ui->Viewer->clear();
...
void CQuickHelpUI::search_function(int step)
{
	switch (step) {
	case 5:
		ui->Viewer->clear();
		ui->Viewer->append("<div id = \"codetrace\" class = \"panel\" style = \"background-color: rgb(255, 255, 255); width: 420px; height: 420px;\">"
			"<div id = \"code5\" style = \"background-color: rgb(255, 255, 255); color: rgb(170,0,0);font-size:18px;\">" + QString::fromLocal8Bit("&nbsp;路径标记完毕") + "< / div>""< / div>");
		// Perform the first step of the search function and display the corresponding text
		break;
	case 2:
		ui->Viewer->clear();
		ui->Viewer->append("searched");
		// Perform the second step of the search function and display the corresponding text
		break;
	case 3:
		ui->Viewer->clear();
		ui->Viewer->append("<div id = \"codetrace\" class = \"panel\" style = \"background-color: rgb(46, 187, 209); width: 420px; height: 420px;\">"
			"<div id = \"code5\" style = \"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);font-size:18px;\">" + QString::fromLocal8Bit("&nbsp;左子树不为空并且数据小于节点的值") + "< / div>"
			"<div id = \"code5\" style = \"background-color: rgb(255, 255, 255); color: rgb(170, 0, 0);font-size:18px;\">" + QString::fromLocal8Bit("开始标红左子树") + "< / div>"
			"< / div>");
		// Perform the third step of the search function and display the corresponding text
		break;
	case 4:
		ui->Viewer->clear();
		ui->Viewer->append("<div id = \"codetrace\" class = \"panel\" style = \"background-color: rgb(46, 187, 209); width: 420px; height: 420px;\">"
			"<div id = \"code5\" style = \"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);font-size:18px;\">" + QString::fromLocal8Bit("&nbsp;右子树不为空并且数据大于节点的值") + "< / div>"
			"<div id = \"code5\" style = \"background-color: rgb(255, 255, 255); color: rgb(170, 0, 0);font-size:18px;\">" + QString::fromLocal8Bit("&nbsp;开始标红右子树") + "< / div>"
			"< / div>");
		// Perform the fourth step of the search function and display the corresponding text
		break;
