...
void CNodeEditorScene::initialize()
{
	...
	CAttribute nodeAttr("color", "Color", QColor(115, 251, 253), ATTR_FIXED);
...
void CNodeEditorScene::drawText(int location)
{
	...
	pItem->setPlainText(QString::fromLocal8Bit("希尔排序"));  // 纯文本
	pItem->setDefaultTextColor(QColor(0, 0, 0));  // 文本色
	pItem->setPos(QPointF(-50,-100));//位置
...
void CNodeEditorScene::drawline(int location,int i) {
	//绘制线段
	...
	pen.setWidth(5);
	lineItem->setPen(pen);
	lineItem->setLine(-438 + (i - location) * 50 + location * 50, -37, -425 + (i - location) * 50 + location * 50, -25);
	addItem(lineItem);
	...
	lineItem1->setLine(-413 + (i - location) * 50 + location * 50, -37, -425 + (i - location) * 50 + location * 50, -25);
	addItem(lineItem1);
	QGraphicsLineItem *lineItem2 = new QGraphicsLineItem();//"|"
	QPen pen2 = lineItem2->pen();//画笔 绘制外框
	pen2.setColor(QColor(100, 149, 237));//外边框的颜色
	pen2.setWidth(5);
	lineItem2->setPen(pen2);
	lineItem2->setLine(-425 + (i - location) * 50 + location * 50, -62, -425 + (i - location) * 50 + location * 50, -25);
	addItem(lineItem2);
	
}
void CNodeEditorScene::drawlineswap(int location, int i) {
	//绘制线段
	QGraphicsLineItem *lineItem = new QGraphicsLineItem();//"\"
	QPen pen = lineItem->pen();//画笔 绘制外框
	pen.setColor(QColor(255, 0, 0));//外边框的颜色
	pen.setWidth(5);
	lineItem->setPen(pen);
	lineItem->setLine(-438 + (i - location) * 50 + location * 50, -37, -425 + (i - location) * 50 + location * 50, -25);
	addItem(lineItem);
	...
	QGraphicsLineItem *lineItem2 = new QGraphicsLineItem();//"|"
	QPen pen2 = lineItem2->pen();//画笔 绘制外框
	pen2.setColor(QColor(255, 0, 0));//外边框的颜色
	pen2.setWidth(5);
	lineItem2->setPen(pen2);
	lineItem2->setLine(-425 + (i - location) * 50 + location * 50, -62, -425 + (i - location) * 50 + location * 50, -25);
	addItem(lineItem2);
...
void CNodeEditorScene::insertfindnode(int location, int data)
{
	...
	pItem->setPen(pen);
	pItem->setBrush(QBrush(QColor(255, 255, 0)));

	// 矩形区域 起点：(50, 50) 宽：100 高：100
	pItem->setRect(QRectF(px - 25, py-25 , 50, 50));
