...
//CBiTreeNode* CBiTree::insert(CBiTreeNode* root, const QStringList& input, int& index)
CBiTreeNode* CBiTree::insert(CBiTreeNode* root, const QStringList& input, int index)
//CBiTreeNode* CBiTree::insert(CBiTreeNode* root, const int& input, int index)
//CBiTreeNode* CBiTree::insert(CBiTreeNode* root, const int& input, int index)
{
	if (index >= input.size()) 
	{
	...
	//root = new CBiTreeNode(key, NULL, NULL);
	root = new CBiTreeNode(current, NULL, NULL);


	index++;
	root->left = insert(root->left, input, index);
	index++;
	root->right = insert(root->right, input, index);
...
CBiTreeNode* CBiTree::ct() {
	CBiTreeNode *r1 = new CBiTreeNode('A', NULL, NULL);
	CBiTreeNode *r2 = new CBiTreeNode('B', NULL, NULL);
	CBiTreeNode *r3 = new CBiTreeNode('C', NULL, NULL);
	CBiTreeNode *r4 = new CBiTreeNode('D', NULL, NULL);
	CBiTreeNode *r5 = new CBiTreeNode('H', NULL, NULL);
	CBiTreeNode *r6 = new CBiTreeNode('F', NULL, NULL);
	CBiTreeNode *r7 = new CBiTreeNode('G', NULL, NULL);
	//hahahah(0, r1);
	r1->left = r2;
	//hahahah(1, r1);
	r1->right = r3;
