...
public:
	...
	CBiTreeNode(QString current, CBiTreeNode* left, CBiTreeNode* right) :current(current), height(0),
		left(left), right(right) {}
};
class CBiTree
{
...
public:
	...
	//CBiTreeNode* insert(CBiTreeNode* root, const QStringList& input, int& index);
	CBiTreeNode* insert(CBiTreeNode* root, const QStringList& input, int index);
	CBiTreeNode* ct();
	//CBiTreeNode* insert(CBiTreeNode* root, const int& input, int index);
	//CBiTreeNode* insert(CBiTreeNode* root, int* input, int index);
