...
public:
	...
	void DFSTraverse2(MGraph g, vector<int>& nums);
	void DFS2(MGraph g, int index, vector<int>& nums);
...
private:
	...
	QVector<QString> getShortestPathLengthK(const MyGraph& graph, const QString& v, int k);
};