...
public:
	...
	void clearScreen();
	void drawCircle(int x, int y, int data, int p_x, int p_y); //»æÖÆ¶¥µã+±ß
	void drawCircle(int x, int y, int data, int p_x, int p_y, int color); //»æÖÆºìºÚÊ÷¶¥µã+±ß
	void drawCircleSearch(int x, int y, int data, int p_x, int p_y); //»æÖÆ¶¥µã+±ß
	void drawCircleSearch2(int x, int y, int data1, int data2, int p_x, int p_y);
	void drawCircle_search(int x, int y, int data, int p_x, int p_y, int data1);//»æÖÆËÑË÷½á¹û
	void drawCircle_search(int x, int y, int data, int p_x, int p_y, int data1, int color);//»æÖÆºìºÚÊ÷ËÑË÷½á¹û
	void drawCircle2(int x, int y, int data1, int data2, int p_x, int p_y);
	void drawCircle2(int x, int y, int data1, int data2, int p_x, int p_y, int color);//»æÖÆºìºÚÊ÷¶¥µã+±ß
	void drawCircle_simulate(int x, int y, int data, int p_x, int p_y);

	void printInOrd(int x, int y, QString InOrd);//»æÖÆÏÈÐò±éÀú
