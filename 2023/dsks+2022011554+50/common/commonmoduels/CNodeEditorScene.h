...
public:
	...
	void drawCircleSearch(int x, int y, int data, int p_x, int p_y); //绘制顶点+边
	...
	void drawCircle_search2(int x, int y, int data, int p_x, int p_y, int data1);//绘制搜索结果
	void printInOrd(int x, int y, QString InOrd);//绘制先序遍历

	void drawCircle(int x, int y, int data, QColor color = QColor(255, 255, 255)); //绘制圆顶点
	void drawLine(int x1, int y1, int x2, int y2, QColor color = QColor(0, 0, 0)); //绘制连线
