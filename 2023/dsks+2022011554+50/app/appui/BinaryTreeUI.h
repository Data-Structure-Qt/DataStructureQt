...
private slots:
	...
	//平衡二叉树节点查找公共父节点函数
	void on_binarytree_public_parentnode_search_btn_clicked();
	//平衡二叉树递归展示函数
	...
	void drawActive(int totaltime, int frametime, int x);
...
private:
	...
	//CBiTree* avlTree;//新建平衡二叉树
	CFibonacciTree* avlTree;//新建斐波那契二叉树
