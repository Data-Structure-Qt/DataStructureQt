...
private slots:
	...
	//最终输出函数
	void on_binarytree_SimulationTree_out_btn_clicked();
	//仿真二叉树创建函数
	void on_binarytree_SimulationTree_creat_btn_clicked();
	//二叉树删除函数
	void on_binarytree_delete_btn_clicked();
	//二叉树节点插入函数
	void on_binarytree_node_insert_btn_clicked();
	//最大堆堆顶元素删除函数
	void on_binarytree_node_deletetop_btn_clicked();
	//二叉树节点删除函数
	void on_binarytree_node_delete_btn_clicked();
	//二叉树节点查找函数
	void on_binarytree_node_search_btn_clicked();
	
	void on_binarytree_final_btn_clicked(int k);
	//二叉树递归展示函数
