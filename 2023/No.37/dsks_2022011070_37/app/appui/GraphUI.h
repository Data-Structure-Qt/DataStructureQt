...
public:
	...
	void NodeChangeColor_1(QString nodeID);
	void NodeChangeColor_2(QString nodeID);
	void NodeChangeColorWithoutSuspand(QString nodeID);
	void EdgeChangeColor_1(QString firstNodeID, QString lastNodeID);
	void EdgeChangeColor_2(QString firstNodeID, QString lastNodeID);
