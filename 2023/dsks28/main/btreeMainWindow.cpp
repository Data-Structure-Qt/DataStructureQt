...
btreeMainWindow::btreeMainWindow(QWidget* parent) :
	Super(parent)
{
	QString bitString;
	...
	QApplication::setApplicationVersion(btreeVersionString);
...
btreeMainWindow::~btreeMainWindow()
{
	// causes crash here 
	destroyDocument();
}
void btreeMainWindow::init(const QStringList& args)
{
...
QSettings& btreeMainWindow::getApplicationSettings() const
{
	if (m_portable)
	{
...
bool btreeMainWindow::createDocument(const QByteArray& docType)
{  // scene 
	if (docType == "graph")
	{
...
void btreeMainWindow::destroyDocument()
{
...
void btreeMainWindow::onNewDocumentCreated(const QByteArray& docType)
{
	// wizard 
	if (docType == "graph") {
...
bool btreeMainWindow::openDocument(const QString& fileName,
	QByteArray& docType)
{
...
bool btreeMainWindow::saveDocument(const QString& fileName,
...
QString btreeMainWindow::getAboutText() const
{
...
void btreeMainWindow::doReadSettings(QSettings& settings)
{
...
void btreeMainWindow::doWriteSettings(QSettings& settings)
{
...
// privates 
void btreeMainWindow::updateFileAssociations()
{
