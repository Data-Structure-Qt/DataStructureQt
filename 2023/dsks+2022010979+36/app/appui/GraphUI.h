...
public:
	...
	void DFS(MGraph g, int index, QList<QString> currentPath, int currentPathLength);
...
private slots:
	...
	void on_longestPath_btn_clicked();
protected:
	void onSceneAttached(CEditorScene* scene);
	void onSceneDetached(CEditorScene* scene);
private:
	Ui::GraphUI *ui;
	QList<QString> maxPathNodes;  // 用于存储最长路径的节点
	int maxPathLength;  // 用于存储最长路径的长度
	...
	void GraphUI::ChangeColorForLongestPath();
};