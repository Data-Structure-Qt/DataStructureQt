...
#include <baseioui/CImportExportUIController.h>

#include <appbase/CMainWindow.h>

#include <base/CNode.h>
#include <base/CEdge.h>
#include <base/CImageExport.h>
#include <base/CPDFExport.h>
#include <base/CFileSerializerXGR.h>
#include <base/CNodeEditorScene.h>
#include <base/CNodeSceneActions.h>
#include <base/CEditorSceneDefines.h>
#include <base/CEditorView.h>
#include <base/ISceneItemFactory.h>
...
void CNodeEditorUIController::createMenus()
{
    ...
    QAction *undoAction = editMenu->addAction(QIcon(":/Icons/Undo"), QString::fromLocal8Bit("撤销"));
    ...
    modeNodesAction = editMenu->addAction(QIcon(":/Icons/Mode-AddNodes"), QString::fromLocal8Bit("创建"));
	...
	modeFactorAction = editMenu->addAction(QIcon(":/Icons/Mode-Factor"), QString::fromLocal8Bit("放缩"));
    ...
    modeTreeAction = editMenu->addAction(QIcon(":/Icons/Icons/addtree"), QString::fromLocal8Bit("新建树"));
    ...
    fitZoomAction = m_viewMenu->addAction(QIcon(":/Icons/ZoomFit"), QString::fromLocal8Bit("适应窗口"));
    ...
    fitZoomSelectedAction = m_viewMenu->addAction(QIcon(":/Icons/ZoomFitSelected"), QString::fromLocal8Bit("最佳比例"));
	...
	fitZoomBackAction = m_viewMenu->addAction(QIcon(":/Icons/ZoomFitBack"), QString::fromLocal8Bit("回退"));
...
void CNodeEditorUIController::createPanels()
{
    ...
    // connections
    m_parent->createDockWindow(
        "connectionsDock", QString::fromLocal8Bit("拓扑关系"), Qt::LeftDockWidgetArea,
	...
	m_parent->createDockWindow(
		...
		m_linklistPanel = new CGraphEditorUI(m_parent)
	);
...
void CNodeEditorUIController::onSceneChanged()
{
    ...
    m_statusLabel->setText(QString::fromLocal8Bit("节点数")+tr(": %1 | ").arg(nodes.size())+ QString::fromLocal8Bit("边数") +tr(": %1").arg(edges.size()));
