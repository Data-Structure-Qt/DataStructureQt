	...
	Super(parent)
{
	...
	QApplication::setApplicationVersion(baseVersionString);
...
void baseMainWindow::init(const QStringList& args)
{
...
QSettings& baseMainWindow::getApplicationSettings() const
{
	if (m_portable)
	{
		static QString localINI = QCoreApplication::applicationDirPath() + "/base.ini";
...
bool baseMainWindow::createDocument(const QByteArray &docType)
{
    // scene
    if (docType == "graph")
    {
...
void baseMainWindow::destroyDocument()
{
...
void baseMainWindow::onNewDocumentCreated(const QByteArray &docType)
{
	// wizard
	if (docType == "graph")
	{
...
bool baseMainWindow::openDocument(const QString &fileName, QByteArray &docType)
{
...
bool baseMainWindow::saveDocument(const QString &fileName, const QString &/*selectedFilter*/, const QByteArray &docType)
{
    // text
    if (docType == "text")
    {
...
QString baseMainWindow::getAboutText() const
{
...
void baseMainWindow::doReadSettings(QSettings& settings)
{
...
void baseMainWindow::doWriteSettings(QSettings& settings)
{
...
void baseMainWindow::updateFileAssociations()
{
#if defined Q_OS_WIN32

	CPlatformWin32::registerFileType("base.xgr", "base native graph document", ".xgr", 0);
