...
public:
	...
	//3叉树绘制
	void drawCircle3(int x, int y, char data, int p_x, int p_y);
	//更新边
	void NewLine(char data1,int x, int y, char data2,int p_x, int p_y);
	//把边变为黑色
	void BlackLine(char data1, int x, int y, char data2, int p_x, int p_y);
