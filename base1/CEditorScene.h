...
public:
	...
	template<class T = CItem>
	QList<T*> getItemsByValue(const QString& value) const;
...
protected:
	...
	virtual void createItemLabel(QGraphicsItem* setItem);
...
template<class T>
QList<T*> CEditorScene::getItemsByValue(const QString& value) const
{
	QList<T*> res;
