	...
	Super(parent)
{
	...
	QApplication::setApplicationName(QString::fromLocal8Bit("数据结 构可视化实验平台"));
		QApplication::setApplicationVersion(baseVersionString);
	CDocumentFormat xgr = { "XGR binary graph format", "*.xgr", { "xgr" },
	true, true };
...
bool baseMainWindow::openDocument(const QString &fileName,
	QByteArray &docType)
{
...
bool baseMainWindow::saveDocument(const QString &fileName,
